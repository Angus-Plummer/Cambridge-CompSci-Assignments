...
public class GuiLife extends JFrame {
	...
	private JComponent createSourcePanel() {
		JPanel result = new SourcePanel(){ //create anonymous class, extends SourcePanel
	...
	private JComponent createPatternPanel() {
		patternPanel = new PatternPanel(){ //create anonymous class, extends PatternPanel
	...
	private JComponent createControlPanel() {
		controlPanel = new ControlPanel(){  //create anonymous class, extends ControlPanel
